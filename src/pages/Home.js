...
const experiences = [
	{
		...
		orgDescription:
			'GrammaTech is a cybersecurity company that sells security solutions used by businesses across the world.',
		description: [
		...
		tech: ['Angular', 'TypeScript', 'GraphQL']
	},
	{
		title: 'Hussle',
		role: 'Software Engineering Intern',
	...
	{
		title: 'Association of Computing Machinery - Hack Committee',
		role: 'President',
...
function Fun() {
	return (
		<div id='homePage'>
			...
			<p>
				I am many things. A Smash bros god, an academic weapon, a mediocre
				artist, and a fantastic friend.
			</p>
			<p>But most of all, I'm super employable.</p>
			<p>If you want an awesome employee, you've come to the right place.</p>
		</div>
	);
}
